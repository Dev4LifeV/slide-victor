...
export default function Home() {
  ...
  const nextPage = () => {
    if (currentPage === 8 && userInput.length < 400) {
      alert(
        "vagaubdo,mostra sneitmento e fala o que tu snetne envod essa iagme"
      );
      return;
    }
      ...
      case 1:
        return (
          <div>
            <h1>
              {" "}
              bem-vindo a &lt;insira sua apresentação aqui&gt;.hoje falaremos
              sobre
            </h1>
      ...
      case 3:
        return (
          <div>
            ...
            {pongWinner === 1 ? (
              <p className="blink">
                Parabes.voce e o vecedor e o player 2 que vai continua
                aprensntano
              </p>
            ) : (
              <p className="blink">
                voce e bom. voce e tao bom player 2 q vai temrina de apresentar
                so slid
              </p>
            )}
          </div>
      ...
      case 4:
        return (
          <div>
            ...
            <p>
              O sapo não lava o pé mas lava a pata do cavalo que relincha no
              brejo da meia-noite enquanto as galinhas cantam ópera para as
              vacas leiteiras.
            </p>
          </div>
        );
      ...
      case 7:
        return (
          <div>
            ...
            <p>
              Tente encontrar os botões para continuar... eles estão em algum
              lugar...
            </p>
          ...
          <div>
            ...
            <div className="big-image">
              <iframe
                width="560"
                height="315"
                src="https://www.youtube.com/embed/MPNQgsVupKo?si=NHVjOdZ5kq_L-vR9&autoplay=1"
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A apresentação mais engraçada de 2002"
        />
      </Head>
...
const PongGame = ({ onWin }) => {
  ...
  useEffect(() => {
    ...
    const gameLoop = (timestamp) => {
      ...
      if (keys["s"] || keys["S"]) {
        setPaddle1Y((prev) =>
          Math.min(GAME_HEIGHT - PADDLE_HEIGHT, prev + PADDLE_SPEED)
        );
      }
      if (keys["ArrowUp"]) {
      ...
      if (ballX <= PADDLE_WIDTH && ballX >= 0) {
        ...
        if (
          ballCenterY >= paddle1Y &&
          ballCenterY <= paddle1Y + PADDLE_HEIGHT
        ) {
          ...
          const hitPosition =
            (ballCenterY - paddle1CenterY) / (PADDLE_HEIGHT / 2);
      ...
      if (
        ...
        if (
          ballCenterY >= paddle2Y &&
          ballCenterY <= paddle2Y + PADDLE_HEIGHT
        ) {
          ...
          // Add angle based on where the ball hits the paddle
          const hitPosition =
            (ballCenterY - paddle2CenterY) / (PADDLE_HEIGHT / 2);
          setBallSpeedY((prev) => prev + hitPosition * 3);
        }
      }
  ...
  return (
    <div style={{ textAlign: "center" }}>
      ...
      >
        <h4>Controles:</h4>
        <p>
          <strong>Player 1:</strong> W (cima) S (baixo) - Segure para mover
          continuamente
        </p>
        <p>
          <strong>Player 2:</strong> ↑ (cima) ↓ (baixo) - Segure para mover
          continuamente
        </p>
      </div>
